        ...
        Expanded(
          child: Center(
            child: Text(
              ...
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color(0xFF584BDD)),
            ),
          ),
        ),
      );
                            ...
                            decoration: BoxDecoration(
                              color: startDate != null && endDate != null
                                  ? getIsItStartAndEndDate(date) || getIsInRange(date)
                                      ? Color(0xFF584BDD).withOpacity(0.4)
                                      : Colors.transparent
                                  : Colors.transparent,
                    ...
                    Material(
                      ...
                      child: InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: getIsItStartAndEndDate(date) ? Color(0xFF584BDD) : Colors.transparent,
                              borderRadius: BorderRadius.all(Radius.circular(32.0)),
                              border: Border.all(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: DateTime.now().day == date.day && DateTime.now().month == date.month && DateTime.now().year == date.year
                                ? getIsInRange(date) ? Colors.white : Color(0xFF584BDD)
                                : Colors.transparent,
